  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-imbari-very-dark-brown">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center items-center justify-center">
        <article className="card relative overflow-hidden p-6 sm:p-7 text-sm text-imbari-very-dark-brown">
          ...
          <p className="text-xs text-imbari-very-dark-brown max-w-xs mx-auto text-center">
      ...
      {/* GLOBAL ROUTES */}
      <section className="card p-6 sm:p-8 text-sm text-imbari-very-dark-brown space-y-4 text-center">
        <h2 className="font-semibold text-amber-200 text-lg text-center">
          Global Routes
        </h2>
        <p className="text-xs text-imbari-very-dark-brown max-w-md mx-auto text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
          {[
            ...
            <div
              key={region}
              className="rounded-lg border border-emerald-500/30 bg-emerald-950/40 px-3 py-2 text-[11px] text-imbari-very-dark-brown shadow-sm mx-auto"
            >
              {region}
            </div>
          ))}
      ...
      <section className="card p-6 sm:p-8 text-sm text-imbari-very-dark-brown space-y-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-2">
          {[
            ...
            <div
              key={benefit}
              className="rounded-lg border border-emerald-500/30 bg-emerald-950/40 px-4 py-3 text-[11px] text-imbari-very-dark-brown shadow-sm mx-auto"
            >
              {benefit}
            </div>
          ))}
        ...
        <p className="text-[11px] text-imbari-very-dark-brown max-w-md mx-auto pt-2">
