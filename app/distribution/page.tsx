    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center items-center justify-center">
        <article className="card relative overflow-hidden p-6 sm:p-7 text-sm text-gray-100">
          ...
          <p className="text-xs text-white max-w-xs mx-auto text-center">
      ...
      <section className="card p-6 sm:p-8 text-sm text-gray-100 space-y-4 text-center">
        ...
        <p className="text-xs text-white max-w-md mx-auto text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
          {[
            ...
            <div
              key={region}
              className="rounded-lg border border-emerald-500/30 bg-emerald-950/40 px-3 py-2 text-[11px] text-white shadow-sm mx-auto"
            >
              {region}
            </div>
          ))}
      ...
      <section className="card p-6 sm:p-8 text-sm text-gray-100 space-y-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-2">
          {[
            ...
            <div
              key={benefit}
              className="rounded-lg border border-emerald-500/30 bg-emerald-950/40 px-4 py-3 text-[11px] text-white shadow-sm mx-auto"
            >
              {benefit}
            </div>
          ))}
        ...
        <p className="text-[11px] text-white max-w-md mx-auto pt-2">
