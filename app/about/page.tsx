      ...
      <section className="w-full min-h-screen max-w-7xl mx-auto flex flex-col gap-16 animate-fade-in justify-center py-20 pb-32">
        ...
        <section className="grid gap-12 md:grid-cols-3 w-full min-h-[60vh] items-center">
          <div className="card p-16 text-center flex flex-col items-center bg-gradient-to-br from-black/80 via-neutral-900 to-black/90 border border-emerald-500/10 shadow-2xl rounded-3xl min-h-[48vh] h-full">
            ...
            <div className="space-y-8 mt-6 w-full">
              <div>
                <h3 className="text-lg font-semibold text-imbari-very-dark-brown mb-2">🌄 Mt. Elgon — Bugisu Arabica</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-imbari-very-dark-brown mb-2">🏔️ Rwenzori Mountains — Fine Robusta</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-imbari-very-dark-brown mb-2">🌱 Victoria Basin — Microlot Farms</h3>
          ...
          <div className="card p-16 text-center flex flex-col items-center bg-gradient-to-br from-black/80 via-neutral-900 to-black/90 border border-emerald-500/10 shadow-2xl rounded-3xl md:col-span-2 min-h-[48vh] h-full">
            ...
            <p className="text-base text-imbari-very-dark-brown max-w-2xl mx-auto mb-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 w-full">
              <div className="bg-white/5 rounded-xl px-8 py-6 text-base text-imbari-very-dark-brown font-medium shadow-lg">
        ...
        <section className="grid gap-12 md:grid-cols-2 w-full min-h-[60vh] items-center">
          <div className="card p-16 text-center flex flex-col items-center bg-gradient-to-br from-black/80 via-neutral-900 to-black/90 border border-emerald-500/10 shadow-2xl rounded-3xl min-h-[48vh] h-full">
            ...
            <p className="text-base text-imbari-very-dark-brown max-w-xl mx-auto mb-6">
              We operate a fully integrated value chain that keeps quality and traceability under one roof:
            </p>
            <div className="grid gap-4 w-full">
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Farmer partnerships &amp; agronomy training</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Sustainable farm practices and inputs</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Microlot profiling &amp; cupping</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Processing, roasting, and instant manufacturing</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Export logistics and distribution across Africa &amp; beyond</div>
            </div>
          </div>
          ...
          <div className="card p-16 text-center flex flex-col items-center bg-gradient-to-br from-black/80 via-neutral-900 to-black/90 border border-emerald-500/10 shadow-2xl rounded-3xl min-h-[48vh] h-full">
            ...
            <div className="grid gap-4 w-full">
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Above-market pricing and reliable offtake</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Long-term purchasing contracts</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Agronomy and quality training</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Access to financial tools and new markets</div>
              <div className="bg-white/5 rounded-xl px-8 py-5 text-base text-imbari-very-dark-brown font-medium shadow-lg">Distribution access across Africa’s 54 states</div>
            </div>
          </div>
        </section>
      </section>
